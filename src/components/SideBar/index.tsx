...
export function SideBar() {
  ...
  return (
    <main className="h-screen text-muted-foreground bg-background">
      <div>
        <nav className="bg-background border-b border-gray-200 fixed z-30 w-full">
        ...
        <div className="flex overflow-hidden bg-background pt-16">
          <aside
            ...
            aria-label="Sidebar"
          >
            <div className="relative flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-background pt-0">
