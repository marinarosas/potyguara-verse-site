...
export default function ProductCategory() {
  ...
  return (
    <div id="servicos" className="p-5 gap-10 flex flex-col items-center">
      ...
      <h3
        ...
        className="hidden lg:block textmin text-secondary-100 font-light text-center"
      >
        é mais do que uma pergunta é o convite para transformar ideias em
        realidade
        <br />e impulsionar o seu sucesso online
      </h3>
      ...
      <h3
        data-aos="fade-up"
        data-aos-duration="1500"
        className="lg:hidden textmin text-secondary-100 font-light text-justify"
      >
        é mais do que uma pergunta é o convite para transformar ideias em
        realidade e impulsionar o seu sucesso online
      </h3> */}
      <div
              ...
              <div className="max-w-sm">
                ...
                <div className="flex flex-col lg:h-48 h-56 justify-center items-center p-5">
                  <a href="#" className="flex flex-row w-full gap-2 ">
                    ...
                    <h5 className="mb-2 text-2xl font-light tracking-tight text-secondary-100">
                      {item.blueTitle}
                    </h5>
                  </a>
